    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbars">
            <ul class="navbar-nav ms-auto mb-2 mb.lg-0">
                <li class="nav-item">
                    <a href="/VidaSubmarina/paginaInicio/" class="nav-link">inicio</a>
                </li>
                <li class="nav-item">
                    <a href="#footer" class="nav-link">contactanos</a>
                </li>
                <li class="nav-item">
                    <a href="/VidaSubmarina/paginaInicio/paginasecciones/secciones.php" class="nav-link">secciones</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        <div class="col-lg-4 col-md-12 col-12">
            <div class="about-img">
                <img src="../imagenes/img11.jpg" alt="">
            </div>
        </div>
